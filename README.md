...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/markdown-include-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11042&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/markdown-include-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `markdown-include` can be installed with:

```
conda install markdown-include
```

It is possible to list all of the versions of `markdown-include` available on your platform with:
